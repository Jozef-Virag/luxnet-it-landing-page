      ...
      <div class="text-center space-y-8">
        ...
        >
          <h1>
            ...
            <br>
            Tvorba webov & PC Služby
          </h1>
        </div>

        <p class="max-w-screen-sm mx-auto text-xl text-muted-foreground">
          Ponúkame profesionálny vývoj webových stránok a opravy počítačov. Pridajte
          sa k nám a využite riešenia šité na mieru s odbornou podporou.
        </p>

        <div class="space-y-4 md:space-y-0 md:space-x-4">
          <Button class="w-5/6 md:w-1/4 font-bold group/arrow" onclick="location.href='#faq'">
            Začnite
            <ArrowRight
